 ...
 * UiAutomator. Authorized security-training use only. This is a reference copy;
 * the wired-in copy CI compiles lives at
 * android/app/src/androidTest/kotlin/com/dvma/DvmaSmokeTest.kt.
 *
...
class DvmaSmokeTest {
    ...
    private val pkg: String = "com.dvma"
